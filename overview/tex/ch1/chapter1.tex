...
\begin{figure}[H]
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1.5}{\label{subfig:bulk_mag_a:a}\input{../(100).tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1.5}{\label{subfig:bulk_mag_a:b}\input{../(100).tikz}}}
	\end{minipage}
\label{fig:bulk_mag_a}
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1.5}{\label{subfig:bulk_mag_a:a}\input{../(111).tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1}{\label{subfig:bulk_mag_a:b}\input{../miller beispiel.tikz}}}
...
\begin{figure}[H]
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1.5}{\label{subfig:bulk_mag_a:a}\input{../bulk_mag_a.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{1.5}{\label{subfig:bulk_mag_a:b}\input{../bulk_mag_b.tikz}}}
	\end{minipage}\par\medskip
\caption{b}
\label{fig:bulk_mag_a}
\end{figure}
...
\begin{figure}[H]
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.7}{\label{subfig:bulk_mag_a:a}\input{../dcplasma.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.9}{\label{subfig:bulk_mag_a:b}\input{../diffusionsstrom.tikz}}}
	\end{minipage}
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.7}{\label{subfig:bulk_mag_a:a}\input{../hallsensor.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.9}{\label{subfig:bulk_mag_a:b}\input{../Massenwirkungsgesetz.tikz}}}
	\end{minipage}
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.7}{\label{subfig:bulk_mag_a:a}\input{../optik_2.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.9}{\label{subfig:bulk_mag_a:b}\input{../oven.tikz}}}
	\end{minipage}
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.7}{\label{subfig:bulk_mag_a:a}\input{../precursor_a.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.9}{\label{subfig:bulk_mag_a:b}\input{../precursor_b.tikz}}}
	\end{minipage}\par\medskip
\caption{b}
\label{fig:bulk_mag_a}
\end{figure}
\begin{figure}[H]
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.7}{\label{subfig:bulk_mag_a:a}\input{../Schwarzkörperstrahlung.tikz}}}
	\end{minipage}%
	\begin{minipage}{.5\linewidth}
		\centering
		\subfloat[]{\scalebox{.9}{\label{subfig:bulk_mag_a:b}\input{../thyristor.tikz}}}
	\end{minipage}\par\medskip
\caption{b}
\label{fig:bulk_mag_a}
\end{figure}
...
\begin{figure}[H]
	\centering	
	\scalebox{1.5}{\label{subfig:bulk_mag_a:a}\input{../baenderschema_3.tikz}}
	\caption{test}
\end{figure}
